...
const CELL_COUNT = 6;
export default function OTPScreen({phoneNumber, confirmCode}) {
  // If null, no SMS has been sent
  const router = useRoute();
  // const {confirmCode, confirm, phoneNumber} = router.params;
  ...
  return (
    <View style={{flex: 1, marginTop: Platform.OS === 'ios' ? 40 : 0}}>
      ...
      <View style={styles.bottom}>
        ...
        <TouchableOpacity style={styles.btn} onPress={confirmCode(value)}>
